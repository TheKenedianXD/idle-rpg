<template>
  <div class="flex items-center justify-between p-1 relative">
    ...
    <div v-if="upgradable !== false" class="flex items-center gap-2">
      <span v-if="cost !== undefined" class="inline-flex items-center gap-1">
    ...
    <div v-else class="text-zinc-400 text-xs">
      <slot name="suffix"/>
    </div>
...
const canAfford = computed(() =>
    props.cost !== undefined ? store.essence >= props.cost : false
)
