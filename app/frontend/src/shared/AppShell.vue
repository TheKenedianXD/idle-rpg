    ...
    <Teleport to="body">
      ...
      <transition name="slide">
        <aside
            ...
            @keyup.esc="ui.closeSidebar()"
        >
          <div class="flex items-center justify-between mb-4">
            <div class="text-lg font-semibold">Menu</div>
            <button class="p-2 rounded-md hover:bg-zinc-800" @click="ui.closeSidebar()" aria-label="Close menu">
          ...
          <div class="border-t border-zinc-800 pt-3 mt-3 space-y-2 text-sm">
            <a
                class="block text-zinc-300 text-center hover:text-indigo-400"
                href="#"
